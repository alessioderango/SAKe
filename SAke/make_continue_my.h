 ...
 */
template <class Indi>
eoContinue<Indi> & do_make_continue_my(eoParser& _parser, eoState& _state, eoEvalFuncCounter<Indi> & _eval, eoGenContinueMy<Indi> *stop)
{
  //////////// Stopping criterion ///////////////////
  ...
  // and "add" to combined
  continuator = make_combinedContinue<Indi>(continuator, stop);
