...
//                        var window    = component.createObject(applicationWindow1)
        ...
        function openProject(){
            var list = sakeStart.getAllElementsFromProjectName(description_role)
            var matrix= [];
            matrix[0] = [];
...
//                        console.log("WAIT")
        ...
        SplitView {
                    ...
                    itemDelegate:
                        ...
                        Button {
                            ...
                            onClicked: {
                                ...
                                path_output = model.type
                                description_role = model.description_role
                                openProject()
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    console.log("onClicked Right Button "+styleData.value
                                                +" "+model.description_role+ " "+ model.type);
                                    path_output = model.type
                                    if(model.description_role !== "undefined"){
                                        description_role = model.description_role
                                        menu.popup()
                                    }
                                }
            ...
            Menu {
                ...
                MenuItem {
                    text: "View Output"
                    onTriggered: sakeStart.openFile(path_output)
                }
                ...
                MenuItem {
                    ...
                    onTriggered:
                    {
                        var component = Qt.createComponent("DialogDelete.qml");
                                if (component.status === Component.Ready) {
                                var dialog = component.createObject(applicationWindow1,{popupType: 1});
                                dialog.open();
                    }
                     }
