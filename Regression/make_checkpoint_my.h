#ifndef MAKE_CHECKPOINT_MY_H
#define MAKE_CHECKPOINT_MY_H
 ...
 */
template <class EOT>
eoCheckPoint<EOT>& do_make_checkpoint_my(eoParser& _parser,
                                         eoState& _state,
                                         eoValueParam<unsigned long>& _eval,
                                         eoContinue<EOT>& _continue,
                                         CustomPlotItem *& qCustomFitness,
                                         CustomPlotRegression*& qCustomRegression,
                                         QObject *progressbar,
                                         int maxGen,
                                         ...
                                         std::vector< double> _xRegression)
{
    ...
    eoGraphFitnessStat<EOT> *bestStat = NULL;
