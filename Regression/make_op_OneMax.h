...
//  eoPropCombinedQuadOp<Individual> *propXover =
//    new eoPropCombinedQuadOp<Individual>(*cross, cross1Rate);
...
////  eoPropCombinedMonOp<Individual> *propMutation = new eoPropCombinedMonOp<Individual>(*mut, mut1Rate);
...
//  eoProportionalOp<Individual> * propOp = new eoProportionalOp<Individual> ;
//  _state.storeFunctor(propOp);
//  eoQuadOp<Individual> *ptQuad = new eoQuadCloneOp<Individual>;
...
//  // now the sequential
////  eoSequentialOp<Individual> *op = new eoSequentialOp<Individual>;
